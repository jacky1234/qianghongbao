...
public class WechatAccessibilityJob extends BaseAccessibilityJob {
    ...
    public void onReceiveJob(AccessibilityEvent event) {
        ...
        if (eventType == AccessibilityEvent.TYPE_NOTIFICATION_STATE_CHANGED) {
            ...
            if (GrabWXRedPacketService.isNotificationServiceRunning() && getConfig().isEnableNotificationService()) { //开启快速模式，不处理
                return;
            }
     ...
     */
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR2)
    private void handleChatListRedPacket() {
        ...
        List<AccessibilityNodeInfo> list = nodeInfo.findAccessibilityNodeInfosByText("恭喜发财，大吉大利");
