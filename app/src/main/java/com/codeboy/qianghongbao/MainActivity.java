...
public class MainActivity extends BaseSettingsActivity {
    ...
    protected void onResume() {
        super.onResume();
        if (GrabWXRedPacketService.isRunning()) {
            if (mTipsDialog != null) {
                mTipsDialog.dismiss();
            }
        } else {
    ...
    private void showDonateDialog() {
        ...
        view.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                File output = new File(android.os.Environment.getExternalStorageDirectory(), "jacky_wechatpay_qr.jpg");
                if (!output.exists()) {
    ...
    public static class MainFragment extends BaseSettingsFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            weChatPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    if ((Boolean) newValue && !GrabWXRedPacketService.isRunning()) {
            ...
            notificationPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    if (enable && !GrabWXRedPacketService.isNotificationServiceRunning()) {
        ...
        public void updateNotifyPreference() {
            ...
            boolean running = GrabWXRedPacketService.isNotificationServiceRunning();
