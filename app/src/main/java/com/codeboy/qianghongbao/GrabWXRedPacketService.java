 ...
 * 抢红包外挂服务
 */
public class GrabWXRedPacketService extends AccessibilityService {

    private static final Class[] ACCESSIBILITY_JOBS = {
            WechatAccessibilityJob.class,
    };

    private static GrabWXRedPacketService service;

    private List<AccessibilityJob> mAccessibilityJobs;
    private Map<String, AccessibilityJob> mPkgAccessibilityJobMap;
    ...
    public static void handNotificationPosted(IStatusBarNotification notificationService) {
